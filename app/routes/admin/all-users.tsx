...
const AllUsers = () => {
    return (<main className='all-users wrapper'>
        ...
        <GridComponent dataSource={users}>
            <ColumnsDirective>
                <ColumnDirective
                    ...
                    width="200"
                    textAlign="Left"
                    template={(props: UserData) => (<div className='flex items-center gap-1.5 px-4'>
                ...
                <ColumnDirective
                    ...
                    width="100"
                    textAlign='Left'
                    template={({ status }: UserData) => (<article className={cn('status-column', status === 'user' ? 'bg-success-50' : 'bg-light-300')}>
